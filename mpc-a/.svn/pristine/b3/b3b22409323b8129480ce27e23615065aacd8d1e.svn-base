            ...
            <div class="box-content">
                ...
                <form class='form-horizontal' id='form-create-mantenimiento'>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <select class="populate placeholder" id="personal" name="personal">
                                <?php
                                foreach($personal as $persona):
                                    ?>
                                    <option value="<?=$persona->idPersonal; ?>"><?=$persona->nombre1?> <?=$persona->apellido1?> <?=$persona->apellido2?></option>
                                <?php  endforeach;
                                ?>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        <label for="date_example" class="col-sm-2 control-label">Fecha Mantenimiento: </label>
                        <div class="col-sm-4">
