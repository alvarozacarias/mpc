v_create_mantenimiento.php<script src="../validate/js/jquery.validate.min.js"></script>
...
<div class="row">
    <div id="breadcrumb" class="col-md-12">
        <ol class="breadcrumb">
            <li><a href="#">Administrar Hilo de Fibra Optica</a></li>
            <li><a href="#">Crear Hilo de Fibra Optica</a></li>
        </ol>
    </div>
</div>
<div class="row">
        ...
        <div class="box">
            <div class="box-header">
                <div class="box-name">
                    ...
                    <span>Crear Hilo de Fibra Optica</span>
            ...
            <div class="box-content">
                <h4 class="page-header">Formulario de Registro de Hilo de Fibra Optica</h4>
                <div id="mensaje">&nbsp;</div>
