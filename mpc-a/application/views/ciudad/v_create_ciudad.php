...
<div class="row">
    <div id="breadcrumb" class="col-md-12">
        <ol class="breadcrumb">
            <li><a href="#">Administrar Ciudad</a></li>
            <li><a href="#">Crear Ciudad</a></li>
        </ol>
    </div>
</div>
<div class="row">
    <div class="col-xs-12 col-sm-12">
        <div class="box">
            ...
            <div class="box-content">
                <h4 class="page-header">Formulario de Registro de Ciudad</h4>
                <div id="mensaje">&nbsp;</div>
                <form class='form-horizontal' id='form-create-mantenimiento'>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Nombre ciudad: </label>
