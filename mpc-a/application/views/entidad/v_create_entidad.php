...
<div class="row">
    <div id="breadcrumb" class="col-md-12">
        <ol class="breadcrumb">
            <li><a href="#">Administrar Entidad</a></li>
            <li><a href="#">Crear Entidad</a></li>
        </ol>
    </div>
</div>
<div class="row">
    <div class="col-xs-12 col-sm-12">
        <div class="box">
            ...
            <div class="box-content">
                <h4 class="page-header">Formulario de Registro de Entidad</h4>
                <div id="mensaje">&nbsp;</div>
                <form class='form-horizontal' id='form-create-mantenimiento'>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Nombre de entidad: </label>
                        <div class="col-sm-4">
                            <input id="frecuencia" class="form-control" type="text" placeholder="Ingrese el nombre de la entidad" value="" name="frecuencia">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Telefono: </label>
                        <div class="col-sm-4">
                            <input id="frecuencia" class="form-control" type="text" placeholder="Ingrese telefono" value="" name="frecuencia">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Direccion: </label>
                        <div class="col-sm-4">
                            <textarea id="descripcion" class="form-control" placeholder="Ingrese direccion" name="descripcion" rows="3"></textarea>
                        </div>
                    </div>
